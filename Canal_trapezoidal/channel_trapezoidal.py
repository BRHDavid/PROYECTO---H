...
class CanalTrapezoidal(NewtonRaphson):
...
#Modificar formulas para canal trapezoidal
    ...
    def tirante(self):
        ...
        while iteraciones < max_iteraciones:
            self.fx, self.dx = self.rectangular(self.factor_seccion, self.b, self.condicion_inicial)
...
if __name__ == '__main__':
    rectangular  = CanalTrapezoidal(2, 1, 0.001, 0.014)
